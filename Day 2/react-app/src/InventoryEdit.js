...
class InventoryEdit extends Component {
    ...
    // find the right route in the backend router (as long as the 'id' is not 'new')
    ...
    // handles all data from the form once it is submitted and update the database
    ...
    render() {
        const {item} = this.state;
        const title = 
            // set the right heading for this screen either as edit or add
            <h2 className="mt-3">
